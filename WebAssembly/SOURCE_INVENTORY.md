...
- `zh_bink_video_device_compile_frontier`: original
  ...
  movie helper, focused original `SinglePlayerLoadScreen::init`, and focused
  ...
  `finishSinglePlayerInit` branch coverage remain open. The runtime archive extractor
