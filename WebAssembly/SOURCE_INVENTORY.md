...
- `zh_gameengine_real_compile_frontier`: compile-only original
  ...
  `Common/CRCDebug.cpp`, `DamageFX.cpp`, `GameLOD.cpp`, `MiniLog.cpp`,
  `PerfTimer.cpp`, `StateMachine.cpp`, `StatsCollector.cpp`,
  ...
  (`AcademyStats.cpp`, `ActionManager.cpp`, `ScoreKeeper.cpp`, `Team.cpp`),
  `SkirmishBattleHonors.cpp`, system compile leaves (`Radar.cpp`,
  `Upgrade.cpp`), and initial Thing/model-definition sources
  (`DrawModule.cpp`, `Module.cpp`, `ModuleFactory.cpp`, `Thing.cpp`,
  `ThingFactory.cpp`, `ThingTemplate.cpp`) without linking them into the
  current shim-based smoke runtime yet.
