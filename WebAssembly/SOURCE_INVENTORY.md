...
- `gamenetwork-core-smoke`: a Node-executed wasm smoke test that verifies
  ...
  `User` value semantics. `Connection.cpp`, `DownloadManager.cpp`,
  `FileTransfer.cpp`, `NetMessageStream.cpp`, and `NetPacket.cpp` are currently
