...
int main()
{
	...
	std::printf("{\"ok\":true,\"library\":\"GameClient/utility\","
		"\"compiled\":\"Anim2D,AnimateWindowManager,ChallengeGenerals,Color,ControlBarPrintPositions,Credits,CreditsMenu,DebugDisplay,Display,DisplayString,DisplayStringManager,DrawGroupInfo,DrawableManager,ExtendedMessageBox,GameFont,GameWindowGlobal,GameWindowManager,GameWindowManagerScript,GameWindowTransitions,GlobalLanguage,GameText,GraphDraw,HeaderTemplate,IMECandidate,Image,LanguageFilter,Line2D,MessageBox,ParabolicEase,PopupCommunicator,ProcessAnimateWindow,ShellMenuScheme,SinglePlayerMenu,Snow,Statistics,VideoPlayer,VideoStream,Water,WinInstanceData,WindowLayout,WindowVideoManager,WOLCustomScoreScreen,WOLMessageWindow,WOLQMScoreScreen,WOLStatusMenu,GadgetCheckBox,GadgetComboBox,GadgetHorizontalSlider,GadgetListBox,GadgetProgressBar,GadgetRadioButton,GadgetStaticText,GadgetTabControl,GadgetTextEntry,GadgetVerticalSlider\","
