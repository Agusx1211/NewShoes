...
int main()
{
	...
	std::printf("{\"ok\":true,\"library\":\"GameClient/utility\","
		"\"compiled\":\"Anim2D,AnimateWindowManager,CampaignManager,ChallengeGenerals,Color,ControlBarPrintPositions,ControlBarResizer,ControlBarScheme,Credits,CreditsMenu,DebugDisplay,Display,DisplayString,DisplayStringManager,DrawGroupInfo,DrawableManager,Eva,ExtendedMessageBox,FXList,GameFont,GameWindow,GameWindowGlobal,GameWindowManager,GameWindowManagerScript,GameWindowTransitions,GameWindowTransitionsStyles,GlobalLanguage,GameText,GraphDraw,GUICommandTranslator,HeaderTemplate,HintSpy,HotKey,IMECandidate,Image,InGameChat,INIAnimation,INICommandButton,INIMappedImage,INIVideo,INIWater,KeyboardOptionsMenu,LanguageFilter,Line2D,LookAtXlat,MapUtil,MessageBox,MetaEvent,ParabolicEase,PlaceEventTranslator,PopupCommunicator,ProcessAnimateWindow,RadiusDecal,RayEffect,ReplayControls,SelectionInfo,SelectionXlat,ShellMenuScheme,SinglePlayerMenu,SkirmishMapSelectMenu,Snow,Statistics,TerrainRoads,View,VideoPlayer,VideoStream,Water,WindowXlat,WinInstanceData,WindowLayout,WindowVideoManager,WOLCustomScoreScreen,WOLMessageWindow,WOLQMScoreScreen,WOLStatusMenu,GadgetCheckBox,GadgetComboBox,GadgetHorizontalSlider,GadgetListBox,GadgetProgressBar,GadgetPushButton,GadgetRadioButton,GadgetStaticText,GadgetTabControl,GadgetTextEntry,GadgetVerticalSlider\","
