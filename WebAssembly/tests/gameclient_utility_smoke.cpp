...
int main()
{
	...
	std::printf("{\"ok\":true,\"library\":\"GameClient/utility\","
		"\"compiled\":\"Anim2D,AnimateWindowManager,CampaignManager,ChallengeGenerals,Color,ControlBarBeacon,ControlBarMultiSelect,ControlBarOCLTimer,ControlBarObserver,ControlBarPrintPositions,ControlBarResizer,ControlBarScheme,ControlBarStructureInventory,ControlBarUnderConstruction,Credits,CreditsMenu,DebugDisplay,DisconnectWindow,Display,DisplayString,DisplayStringManager,DrawGroupInfo,DrawableManager,EstablishConnectionsWindow,Eva,ExtendedMessageBox,FXList,GameClientDispatch,GameFont,GameWindow,GameWindowGlobal,GameWindowManager,GameWindowManagerScript,GameWindowTransitions,GameWindowTransitionsStyles,GeneralsExpPoints,GlobalLanguage,GameText,GraphDraw,GUICommandTranslator,HeaderTemplate,HintSpy,HotKey,IMECandidate,Image,InGameChat,INIAnimation,INICommandButton,INIMappedImage,INIVideo,INIWater,KeyboardOptionsMenu,LanGameOptionsMenu,LanLobbyMenu,LanMapSelectMenu,LanguageFilter,Line2D,LookAtXlat,MapUtil,MessageBox,MetaEvent,ParabolicEase,PlaceEventTranslator,PopupCommunicator,ProcessAnimateWindow,RadiusDecal,RayEffect,ReplayControls,SelectionInfo,SelectionXlat,ShellMenuScheme,SinglePlayerMenu,SkirmishGameOptionsMenu,SkirmishMapSelectMenu,Snow,Statistics,TerrainRoads,View,VideoPlayer,VideoStream,Water,WindowXlat,WinInstanceData,WindowLayout,WindowVideoManager,WOLCustomScoreScreen,WOLMessageWindow,WOLQMScoreScreen,WOLStatusMenu,GadgetCheckBox,GadgetComboBox,GadgetHorizontalSlider,GadgetListBox,GadgetProgressBar,GadgetPushButton,GadgetRadioButton,GadgetStaticText,GadgetTabControl,GadgetTextEntry,GadgetVerticalSlider\","
