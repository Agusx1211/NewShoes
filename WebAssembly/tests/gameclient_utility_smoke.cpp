...
int main()
{
	...
	std::printf("{\"ok\":true,\"library\":\"GameClient/utility\","
		"\"compiled\":\"Anim2D,AnimatedParticleSysBoneClientUpdate,AnimateWindowManager,AudioDebugDisplay,BeaconClientUpdate,CampaignManager,ChallengeGenerals,ChallengeMenu,Color,ControlBar,ControlBarBeacon,ControlBarCallback,ControlBarCommand,ControlBarCommandProcessing,ControlBarMultiSelect,ControlBarOCLTimer,ControlBarObserver,ControlBarPopupDescription,ControlBarPrintPositions,ControlBarResizer,ControlBarScheme,ControlBarStructureInventory,ControlBarUnderConstruction,Credits,CreditsMenu,DebugDisplay,DifficultySelect,DisconnectMenu,DisconnectWindow,Display,DisplayString,DisplayStringManager,DrawGroupInfo,Drawable,DrawableManager,DrawableSubManager,EstablishConnectionsMenu,EstablishConnectionsWindow,Eva,ExtendedMessageBox,FXList,GameClient,GameClientDispatch,GameFont,GameInfoWindow,GameWindow,GameWindowGlobal,GameWindowManager,GameWindowManagerScript,GameWindowTransitions,GameWindowTransitionsStyles,GeneralsExpPoints,GlobalLanguage,GameText,GraphDraw,GUICommandTranslator,HeaderTemplate,HintSpy,HotKey,IMECandidate,IMEManager,Image,InGameChat,InGamePopupMessage,InGameUI,INIAnimation,INICommandButton,INIMappedImage,INIVideo,INIWater,KeyboardOptionsMenu,LanGameOptionsMenu,LanLobbyMenu,LanMapSelectMenu,LanguageFilter,Line2D,LookAtXlat,MapSelectMenu,MapUtil,MessageBox,MetaEvent,Mouse,ParabolicEase,ParticleSys,PlaceEventTranslator,PopupCommunicator,PopupReplay,PopupSaveLoad,ProcessAnimateWindow,QuitMenu,RadiusDecal,RayEffect,ReplayControls,ReplayMenu,SelectionInfo,SelectionXlat,ShellMenuScheme,SinglePlayerMenu,SkirmishGameOptionsMenu,SkirmishMapSelectMenu,Smudge,Snow,Statistics,SwayClientUpdate,TerrainRoads,TerrainVisual,View,VideoPlayer,VideoStream,Water,WindowXlat,WinInstanceData,WindowLayout,WindowVideoManager,WOLCustomScoreScreen,WOLMessageWindow,WOLQMScoreScreen,WOLStatusMenu,GadgetCheckBox,GadgetComboBox,GadgetHorizontalSlider,GadgetListBox,GadgetProgressBar,GadgetPushButton,GadgetRadioButton,GadgetStaticText,GadgetTabControl,GadgetTextEntry,GadgetVerticalSlider\","
