...
int main()
{
	...
	std::printf("{\"ok\":true,\"library\":\"GameClient/utility\","
		"\"compiled\":\"Anim2D,AnimateWindowManager,BeaconClientUpdate,CampaignManager,ChallengeGenerals,Color,ControlBarBeacon,ControlBarCallback,ControlBarMultiSelect,ControlBarOCLTimer,ControlBarObserver,ControlBarPopupDescription,ControlBarPrintPositions,ControlBarResizer,ControlBarScheme,ControlBarStructureInventory,ControlBarUnderConstruction,Credits,CreditsMenu,DebugDisplay,DisconnectMenu,DisconnectWindow,Display,DisplayString,DisplayStringManager,DrawGroupInfo,DrawableManager,EstablishConnectionsMenu,EstablishConnectionsWindow,Eva,ExtendedMessageBox,FXList,GameClientDispatch,GameFont,GameInfoWindow,GameWindow,GameWindowGlobal,GameWindowManager,GameWindowManagerScript,GameWindowTransitions,GameWindowTransitionsStyles,GeneralsExpPoints,GlobalLanguage,GameText,GraphDraw,GUICommandTranslator,HeaderTemplate,HintSpy,HotKey,IMECandidate,Image,InGameChat,InGamePopupMessage,INIAnimation,INICommandButton,INIMappedImage,INIVideo,INIWater,KeyboardOptionsMenu,LanGameOptionsMenu,LanLobbyMenu,LanMapSelectMenu,LanguageFilter,Line2D,LookAtXlat,MapSelectMenu,MapUtil,MessageBox,MetaEvent,ParabolicEase,ParticleSys,PlaceEventTranslator,PopupCommunicator,ProcessAnimateWindow,QuitMenu,RadiusDecal,RayEffect,ReplayControls,SelectionInfo,SelectionXlat,ShellMenuScheme,SinglePlayerMenu,SkirmishGameOptionsMenu,SkirmishMapSelectMenu,Snow,Statistics,SwayClientUpdate,TerrainRoads,TerrainVisual,View,VideoPlayer,VideoStream,Water,WindowXlat,WinInstanceData,WindowLayout,WindowVideoManager,WOLCustomScoreScreen,WOLMessageWindow,WOLQMScoreScreen,WOLStatusMenu,GadgetCheckBox,GadgetComboBox,GadgetHorizontalSlider,GadgetListBox,GadgetProgressBar,GadgetPushButton,GadgetRadioButton,GadgetStaticText,GadgetTabControl,GadgetTextEntry,GadgetVerticalSlider\","
