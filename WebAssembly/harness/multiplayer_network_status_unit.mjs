...
}), "Network: connecting | Relay: relay.newshoes.gg\nRoom: default-room");
...
}), "Network: online | Relay: relay.newshoes.gg 1/1 | Peers: 1/2\nRoom: default-room");

assert.match(formatMultiplayerNetworkStatus({
  phase: "error",
  error: "Trystero discovery relay timed out after 20000ms",
}), /^Network: error \| Relay: relay\.newshoes\.gg \| Reconnect\nRoom: not selected/);
assert.match(formatMultiplayerNetworkStatus({
  phase: "error",
  error: "Trystero discovery relay timed out after 20000ms",
}), /Reconnect\nRoom: not selected \| Trystero discovery relay timed/);
