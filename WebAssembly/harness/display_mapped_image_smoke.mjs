...
try {
  ...
  if (!renderResult.ok
      ...
      || renderResult.probe?.texture?.source !== "Original ImageCollection::load(512) / INI::loadDirectory path via W3DDisplay::drawImage, WW3DAssetManager, TextureClass::Init, and runtime W3DFileSystem BIG archives"
