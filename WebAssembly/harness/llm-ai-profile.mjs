...
export function buildLlmAiSystemPrompt(profile, { toolProtocol = profile.toolProtocol } = {}) {
  return [
    ...
    "The map-region construction filter reports terrain placement suitability, not buildings. Discover buildings and objectives through routine objectives or inspect_entities.",
