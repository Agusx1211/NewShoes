...
function assertFunctionLexiconRuntimeFrontier(state) {
  ...
  expect(probe.status === "base_function_lexicon_game_info_window_runtime_owned",
...
function assertAudioOwnedFrontier(state) {
  ...
  expect(frontier.functionLexiconRuntime?.ready === false
      && frontier.functionLexiconRuntime.status === "base_function_lexicon_game_info_window_runtime_owned"
...
try {
  ...
  // base shell callbacks, the promoted Challenge/PopupCommunicator/MapSelect/GameInfo owners,
