...
export const PAGES_HARNESS_FILES = Object.freeze([
  ...
  "assets/games/pinball-bumper-war-off.png",
  "assets/games/pinball-bumper-war.png",
  "assets/games/pinball-command-center-war-off.png",
  "assets/games/pinball-command-center-war.png",
  "assets/games/pinball-flipper-war.png",
  "assets/games/pinball-insert-war-off.png",
  "assets/games/pinball-insert-war-on.png",
  "assets/games/pinball-playfield-war.png",
  ...
  "launcher-games.css",
  "launcher-games.mjs",
  "launcher-pinball.css",
  "launcher-pinball.mjs",
