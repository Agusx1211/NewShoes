...
// subsystem edges, full production Challenge persona setup from the normal
// shell/INI path, InGameUI movie loops, and Bink/audio sync remain open. This verifier pins the
