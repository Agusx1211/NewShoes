...
const scripts = [
  ...
  "harness/world-builder-app.mjs",
  "harness/world-builder-catalog.mjs",
  "harness/world-builder-map.mjs",
  "harness/world-builder-store.mjs",
  "harness/world_builder_browser_smoke.mjs",
  "harness/world_builder_map_unit.mjs",
  "harness/world_builder_retail_maps_smoke.mjs",
