...
const scripts = [
  ...
  "harness/custom-map-manager-ui.mjs",
  "harness/custom-map-package-format.mjs",
  "harness/custom-map-package-format_unit.mjs",
  "harness/custom-map-package-importer.mjs",
  "harness/custom-map-package-worker.mjs",
  "harness/custom-map-store.mjs",
  "harness/custom-map-store_unit.mjs",
  "harness/custom_map_manager_browser_smoke.mjs",
  ...
  "harness/webrtc_relay_selection_unit.mjs",
  "harness/webxr-controls.mjs",
  "harness/webxr-d3d8-command-stream.mjs",
  "harness/webxr-d3d8-renderer.mjs",
  "harness/webxr-runtime.mjs",
  "harness/webxr-settings.mjs",
  "cloudflare/trystero-relay/worker_hibernation.test.mjs",
  "cloudflare/trystero-relay/vitest.config.mjs",
