...
function main() {
  ...
  const probeFacts = {
    ...
    bridgeRpc: requireLine(errors, bridge.lines, 24533, /case "mssStartupProbe":/, "bridge mssStartupProbe RPC"),
    bridgePlaybackGuard: requireLine(errors, bridge.lines, 24544, /probe\.playbackReady === false/, "bridge playbackReady false guard"),
