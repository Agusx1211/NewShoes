...
const steps = [
  {
    ...
    validate(payload) {
      ...
      expect(payload.covered?.includes("runtime original GameLogic::processCommandList dispatch of MSG_NEW_GAME through prepareNewGame, original Shell::hideShell, and first-call startNewGame(FALSE) deferral"),
        "startup vertical smoke did not cover runtime original GameLogic MSG_NEW_GAME dispatch through original Shell", payload);
...
console.log(JSON.stringify({
  ...
  nextRequired: [
    ...
    "replace focused runtime PlayerList/ScriptEngine/GlobalData adapters before continuing deferred startNewGame into terrain/player/script load",
