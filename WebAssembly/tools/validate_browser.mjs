...
try {
  ...
  for (const viewport of viewports) {
    ...
    if (realAsset) {
      ...
      await page.waitForFunction(([expectedFile, expectedIni, expectedGameData, expectedAIData, expectedArmor, expectedWeapon, expectedLocomotor, expectedFxList, expectedParticle, expectedAudio, expectedMiscAudio, expectedDamageFx, expectedCrate, expectedOcl, expectedThing, expectedCommand, expectedProgression, expectedPlayer]) => {
