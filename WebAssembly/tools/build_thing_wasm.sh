...
exports=(
  ...
  -Wl,--export=generals_thing_prerequisite_count
  ...
  -Wl,--export=generals_thing_template_first_prerequisite
  -Wl,--export=generals_thing_template_prerequisite_count
  ...
  -Wl,--export=generals_thing_prerequisite_object_index
  -Wl,--export=generals_thing_prerequisite_kind
  -Wl,--export=generals_thing_prerequisite_value_ptr
  -Wl,--export=generals_thing_prerequisite_value_size
  -Wl,--export=generals_thing_prerequisite_token_count
  -Wl,--export=generals_thing_prerequisite_line
)
