...
const [index, headers, redirects, license, legal, manifestText, analytics, retirementWorker, retirementBootstrap, buildInfoText, modPackageWorker, customMapPackageWorker] = await Promise.all([
