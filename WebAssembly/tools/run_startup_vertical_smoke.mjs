...
console.log(JSON.stringify({
  ...
  covered: [
    ...
    'browser boot constructs original W3DFunctionLexicon, verifies W3D device callback-name tables, and loads the core base GUI callback table while base layout/draw tables remain the FunctionLexicon boundary',
  ...
  nextRequired: [
    'replace the remaining base FunctionLexicon layout/draw callback registrations so GameEngine.cpp line 446 can become fully runtime-owned',
