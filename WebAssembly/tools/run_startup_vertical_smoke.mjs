...
console.log(JSON.stringify({
  ...
  covered: [
    ...
    'browser boot constructs original W3DFunctionLexicon, verifies W3D device callback-name tables, and loads the non-network base GUI widget/input, IME draw, representative base layout, original DifficultySelect system/input/init callbacks, and original MainMenu/Credits/Skirmish/SinglePlayer shell callback tables while the remaining shell layout graph remains the FunctionLexicon boundary',
