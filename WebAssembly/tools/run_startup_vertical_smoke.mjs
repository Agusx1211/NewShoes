...
console.log(JSON.stringify({
  ...
  covered: [
    ...
    'browser boot constructs original W3DFunctionLexicon and verifies W3D device callback-name tables while the base FunctionLexicon callback graph remains probe-owned',
  ...
  nextRequired: [
    'replace the probe-owned base FunctionLexicon callback registrations so GameEngine.cpp line 446 can become fully runtime-owned',
