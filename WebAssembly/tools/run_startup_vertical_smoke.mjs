...
console.log(JSON.stringify({
  ...
  covered: [
    ...
    'browser boot constructs original W3DFunctionLexicon, verifies W3D device callback-name tables, and loads the non-network base GUI widget/input plus IME draw callback tables while base layout tables remain the FunctionLexicon boundary',
  ...
  nextRequired: [
    'replace the remaining base FunctionLexicon layout callback registrations so GameEngine.cpp line 446 can become fully runtime-owned',
