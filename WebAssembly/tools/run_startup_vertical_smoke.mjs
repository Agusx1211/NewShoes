...
console.log(JSON.stringify({
  ...
  covered: [
    ...
    'browser boot constructs original W3DFunctionLexicon, verifies W3D device callback-name tables, and loads the non-network base GUI widget/input, IME draw, representative base layout, and original MainMenu/Credits shell callback tables while Skirmish and the remaining shell layout graph remain the FunctionLexicon boundary',
  ...
  nextRequired: [
    'replace the Skirmish and remaining base FunctionLexicon shell layout callback registrations so GameEngine.cpp line 446 can become fully runtime-owned',
