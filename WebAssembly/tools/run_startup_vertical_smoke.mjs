...
console.log(JSON.stringify({
  ...
  covered: [
    ...
    'browser boot constructs original W3DFunctionLexicon, verifies W3D device callback-name tables, and loads the non-network base GUI widget/input, IME draw, and representative original base layout callback tables while the shell layout graph remains the FunctionLexicon boundary',
  ...
  nextRequired: [
    'replace the remaining base FunctionLexicon shell layout callback registrations so GameEngine.cpp line 446 can become fully runtime-owned',
