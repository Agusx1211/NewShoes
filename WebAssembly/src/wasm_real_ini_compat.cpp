...
UNUSED_INI_BLOCK_PARSER(parseDrawGroupNumberDefinition)
...
UNUSED_INI_BLOCK_PARSER(parseLocomotorTemplateDefinition)
UNUSED_INI_BLOCK_PARSER(parseLanguageDefinition)
UNUSED_INI_BLOCK_PARSER(parseMapCacheDefinition)
UNUSED_INI_BLOCK_PARSER(parseMapDataDefinition)
UNUSED_INI_BLOCK_PARSER(parseMappedImageDefinition)
...
UNUSED_INI_BLOCK_PARSER(parseMultiplayerColorDefinition)
UNUSED_INI_BLOCK_PARSER(parseMultiplayerStartingMoneyChoiceDefinition)
UNUSED_INI_BLOCK_PARSER(parseOnlineChatColorDefinition)
UNUSED_INI_BLOCK_PARSER(parseMultiplayerSettingsDefinition)
...
UNUSED_INI_BLOCK_PARSER(parseTerrainRoadDefinition)
UNUSED_INI_BLOCK_PARSER(parseScienceDefinition)
...
UNUSED_INI_BLOCK_PARSER(parseTerrainDefinition)
UNUSED_INI_BLOCK_PARSER(parseUpgradeDefinition)
UNUSED_INI_BLOCK_PARSER(parseVideoDefinition)
UNUSED_INI_BLOCK_PARSER(parseWaterSettingDefinition)
UNUSED_INI_BLOCK_PARSER(parseWaterTransparencyDefinition)
UNUSED_INI_BLOCK_PARSER(parseWeatherDefinition)
