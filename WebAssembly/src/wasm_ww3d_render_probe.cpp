...
void fill_argb_texture_solid_red(D3DLOCKED_RECT &locked_rect, unsigned int width, unsigned int height, unsigned char alpha)
{
...
{
	fill_argb_texture_solid_red(locked_rect, width, height, 0xff);
}

void fill_argb_texture_translucent_red(D3DLOCKED_RECT &locked_rect, unsigned int width, unsigned int height)
{
	fill_argb_texture_solid_red(locked_rect, width, height, 0x40);
}
