...
- [ ] Remaining D3D8 render-state mapping beyond the current
      ...
      diffuse+ambient lights (smooth spot penumbra/falloff variants beyond
      the verified hard-cone spot proof, broader original W3D point-light
      attenuation variants beyond the verified linear point-light proof,
      off-axis/transformed specular fidelity beyond the verified aligned
      directional path, and broader material-source behavior) and other W3D
